...
def readvalues(): #Repeat this function every 1 second
	global adc1, adc2, adc3, volt, curr, temp, SOC, previous_SOC
	...
	print("Voltage is: " + str(volt) + ", Current is: " + str(curr) + ", Temperature is: " + str(temp) + ", Previous SOC % is: " + str(previous_SOC) + ", Measured SOC % is: " + str(SOC))
